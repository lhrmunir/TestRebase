...
class TestTwoArgsProcessor
{
    ...
    {
        TwoArgsProcessor<Integer> multiplyInts = new TwoArgsProcessor<>() {
                @Override 
        ...
        TwoArgsProcessor<Double> addDoubles = new TwoArgsProcessor<>() {
                @Override 
        ...
        TwoArgsProcessor<String> compareStrings = new TwoArgsProcessor<>() {
                @Override 
