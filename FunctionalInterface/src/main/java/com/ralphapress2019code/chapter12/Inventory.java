...
public class Inventory 
{
    ...
    public static void main(String[] args)
    {
        List<Part> parts = Arrays.asList(
           new Part("tires","Goodyear",2, new Item("RX2041",4,75.25), new Item("SX3355",2,90.50)),
           new Part("brakes","EBC",1, new Item("EX8426",2,125.35)),
           new Part("tires","Firestone",1, new Item("FS2112",3,60.47), new Item("FS2479",5,85.20)),
           new Part("brakes","Acme",3, new Item("AC25",1,90.74), new Item("AC26",4,130.22))
        );
        Supplier<Integer> selectOperation = () -> {
            ...
            while (operation < 0 || operation > 5)
            {
                ...
                System.out.print  ("    5 - End program:");
        ...
        Supplier<String> selectPartName = () -> (new Scanner(System.in)).nextLine();
        Supplier<Integer> selectQuantity = () -> Integer.parseInt((new Scanner(System.in)).nextLine());
        Supplier<Double> selectPrice = () -> Double.parseDouble((new Scanner(System.in)).nextLine());
        Supplier<Integer> selectTimeLimit = () -> Integer.parseInt((new Scanner(System.in)).nextLine());
        
        System.out.println("Welcome to Discount Dave's Inventory Program.");
        boolean done = false;
        while (!done)
        {
            switch (selectOperation.get())
            {
                ...
                case 4:
                    System.out.print("Select a part name:");
                    partName = selectPartName.get();
                    System.out.print("Select installation time limit:");
