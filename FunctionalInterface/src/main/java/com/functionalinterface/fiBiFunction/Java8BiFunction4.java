...
*/
// Java8BiFunction4.java on Mkyong Page
...
public class Java8BiFunction4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1  ---->   result = " + result);   // [node, java, javascript]
        ...
        System.out.println("2  ---->   result1 = " + result1);  // [node, java, javascript]
        ...
        System.out.println("3  ---->   result2 = " + result2);  // [c++]
        ...
        System.out.println("4  ---->   result3 = " + result3);  // [2, 4]
    ...
    /*     List<String> result = obj.filterList(list, 3, obj::filterByLength);
    *      where   filterByLength   is BiFunction
    * */
