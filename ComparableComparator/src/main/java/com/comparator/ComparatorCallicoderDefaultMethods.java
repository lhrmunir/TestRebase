...
public class ComparatorCallicoderDefaultMethods
{
    public static void main(String[] args)
    {
        ...
        employees.add(new Employee(99, "Ninety Nine", 234000.00, LocalDate.of(2017, 9, 28)));
        ...
        // Chaining multiple Comparators
        // Sort by Salary. If Salary is same then sort by Name
        Collections.sort(employees, Comparator.comparingDouble(Employee::getSalary).reversed().thenComparing(Employee::getName));
        System.out.println("\nEmployees (Sorted by Salary and Name) : " + employees);
    }
}
