...
public class GeeksForGeeksTest2
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("object data BEFORE setting object to null : ");
        printdata(object);

        object = null;

//        System.out.println("object data AFTER setting object to null : ");
//        printdata(object); // WILL THROW NullPointerException
